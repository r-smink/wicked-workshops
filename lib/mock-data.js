...
export const STATUS_LABEL = {
  pending: ["ww-badge--paused", "Aanvraag"],
  awaiting_payment: ["ww-badge--paused", "Wacht op betaling"],
  confirmed: ["ww-badge--live", "Bevestigd"],
  completed: ["ww-badge--draft", "Afgerond"],
  cancelled_by_customer: ["ww-badge--draft", "Geannuleerd"],
  cancelled_by_provider: ["ww-badge--draft", "Geannuleerd"],
  expired: ["ww-badge--draft", "Verlopen"],
  refunded: ["ww-badge--draft", "Terugbetaald"],
  no_show: ["ww-badge--draft", "No show"],
};
...
export const DASH_NAV = [
  ...
  { key: "bookings", label: "Boekingen", icon: "book" },
...
export const DASH_TITLES = {
  overview: ["Hoi", "Hier staat je week in een oogopslag."],
