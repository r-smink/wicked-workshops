...
function mapWorkshop(w) {
  ...
  return {
    ...
    location_name: w.location_name || w.provider?.location_name || w.location_inherits_provider ? w.provider?.location_name : null,
    address: w.address || w.provider?.address || null,
  };
}
