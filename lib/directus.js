...
export async function directusFetch(path) {
...
export async function getProviderProfile(userId = null) {
  if (userId) {
    ...
    /* Geen provider gevonden voor deze user — return null zodat de
       aanroeper een fallback kan tonen of een provider kan aanmaken. */
    return null;
  }
